...
const en: LocaleDefinition = {
  ...
  wallet: {
    ...
    confirmTxProposalRemoval: 'Are you sure you want to remove transaction proposal [{txp}]?',
    remove: 'Remove'
  },
  transaction: {
  ...
  receive: {
    ...
    addresses: 'Addresses',
    scanAddressesForBalance: 'Scan addresses for balance',
    scanAddressesForBalanceDesc: 'Each verge wallet can generate billions of addresses from your 12-word recovery phrase. A new address is automatically generated and shown each time you receive a payment.',
    addressScanRequested: 'All your addresses are being scanned on the server side to check for unspent funds. This action takes only a minute. There won\'t be any additional feedback after this when funds are found.',
    unusedAddresses: 'Unused addresses',
    noUnusedAddresses: 'No unused addresses found.',
    addressesWithBalance: 'Addresses with balance',
    noAddressesWithBalance: 'No addresses with saldo found.',
  ...
  settings: {
    ...
    walletServiceDetails: 'Choose the default Verge Wallet Service (VWS) server for new wallets, then optionally apply it to your current wallets too.',
    manageWalletService: 'Manage VWS server',
    vwsServer: 'Default VWS server',
    vwsServerDetails: 'Enter the full Verge Wallet Service (VWS) API URL that new or imported wallets should use.',
    vwsServerHint: 'Use the full API URL, for example https://api.vergecurrency.network/vws/api',
    saveDefaultVwsServer: 'Save default server',
    useVergeDefault: 'Use Verge default',
    applyToExistingWallets: 'Apply to existing wallets',
    applyToExistingWalletsDesc: 'Existing wallets keep their current server until you apply this default to them.',
    applyToAllWallets: 'Apply to all wallets',
    vwsServerSaved: 'Default VWS server saved.',
    vwsServerApplied: 'Updated all wallets to use the new VWS server.',
    invalidVwsServer: 'Enter a valid http:// or https:// VWS API URL.',
    noWalletsToUpdate: 'There are no wallets to update yet.',
